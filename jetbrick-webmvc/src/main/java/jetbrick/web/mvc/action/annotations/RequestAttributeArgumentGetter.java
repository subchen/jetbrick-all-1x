...
@Managed
public class RequestAttributeArgumentGetter implements AnnotatedArgumentGetter<RequestAttribute, Object> {
    private String name;
    private boolean required;

    @Override
    public void initialize(KlassInfo declaringKlass, ParameterInfo parameter, RequestAttribute annotation) {
